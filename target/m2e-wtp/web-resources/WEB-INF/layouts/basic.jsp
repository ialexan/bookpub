...
<link href="<c:url value='http://csns.calstatela.edu/static/jqueryui-1.8.14/css/redmond/jquery-ui-1.8.14.custom.css' />" type="text/css"
	rel="stylesheet" />
...
<script type="text/javascript" src="<c:url value='http://csns.calstatela.edu/static/jquery-1.6.4.min.js' />"></script>

<script type="text/javascript" src="<c:url value='http://csns.calstatela.edu/static/jqueryui-1.8.14/js/jquery-ui-1.8.14.custom.min.js' />"></script>

<script type="text/javascript"
	src="<c:url value='http://csns.calstatela.edu/static/js-webshim/minified/extras/modernizr-custom.js' />"></script>

<script type="text/javascript"
	src="<c:url value='http://csns.calstatela.edu/static/js-webshim/minified/polyfiller.js' />"></script>
